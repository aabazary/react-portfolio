    ...
    <div className="relative py-16 bg-white overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto text-center">
          ...
          <p>
            Full Stack Web Developer with an Entrepreneurial background that has
            trained me to manage and solve problems with great efficiency and
            fervor.
          </p>
          <h2 className="mt-4 text-black text-2xl font-bold">
            Technical Skills
          </h2>
          <p>
            HTML5,CSS3, Javascript, Bootstrap, Tailwind, Node Js, Express,
            MySQL, Handlebars.js, Heroku, Insomnia
          </p>
          ...
          <ul className="text-gray-500">
            <li>
              A Gamers Information hub, that allows the storage of Game
              Information, as well as a forum in order to discuss aspects of
              each game.
            </li>
            <li>Primarily responsible for UI/UX of application.</li>
            <li className="mb-4">
              HTML5, Tailwind, Javascript, Node Js, Express, MySQL, Heroku,
              Handlebars.js
            </li>
          </ul>
          ...
          <ul className="text-gray-500">
            ...
            <span className="text-indigo-500">
              edX/Trilogy/2U-Teaching Assistant/Grader(2022-Present)
            </span>

          <ul className="text-gray-500">
            <li>Instructed Students about the MERN Stack</li>
            <li className="mb-4">
              Provided feedback, and debugged code for students
            </li>
          </ul>
           
           
            <span className="text-indigo-500">
              Akon Auto Center- Owner (2012-2022)
            </span>

          <ul className="text-gray-500">
            <li>Recruited and Supervised a team of 8. </li>
            <li className="mb-4">
              Orchestrated a business that after 2 years achieved an annual
              gross sale of $1,000,000.{" "}
            </li>
          </ul>
          <span className="text-indigo-500 mt-6">
            Smog Station 1- Service Manager (2007-2012)
          </span>
          <ul className="text-gray-500">
            <li>Provided Customer Service to Clients</li>
            <li>Organized tasks for Employees to conduct</li>
          </ul>

          <h2 className="mt-4 text-black text-2xl font-bold">Education</h2>
          <p>Full Stack Web Development Certificate:UCSD Extenstion</p>
        </div>
        <div className="mt-4 flex justify-center">
          {/* required to import in order to see the pdf, pulling directly was giving errors */}
          <a
            href={MyPDF}
            download="akon_resume.pdf"
            target="_blank"
            rel="noreferrer"
            type="button"
