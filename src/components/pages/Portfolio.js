      ...
      <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div className="space-y-12">
          <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            <h2 className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">Check Out my Projects</h2>
          </div>
                    ...
                    <ul role="list" className="flex justify-center space-x-5">
                      <li>
                        <a href={person.gitHubUrl} className="text-gray-400 hover:text-gray-300">
                          ...
                          <svg className="w-6 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <li>
                        <a href={person.deployedUrl} className="text-gray-400 hover:text-gray-300">
